...
# путь к папке к исходными файлами в формате .xlsx (основной документ)
OUTPUT_INPUT_DATA_FORMAT_XLSX_MAIN_DIRECTORY_PATH = DATA_PATH / "OUTPUT" / "INPUT_DATA_FORMAT_XLSX" / "MAIN"
# путь к папке к исходными файлами в формате .xlsx (заявление на взыскание)
OUTPUT_INPUT_DATA_FORMAT_XLSX_APPLICATION_DIRECTORY_PATH = DATA_PATH / "OUTPUT" / "INPUT_DATA_FORMAT_XLSX" /"APPLICATION"
...
APPLICATION_FOR_WITHDRAWAL = 'APPLICATION_FOR_WITHDRAWAL'
APPLICATION_FOR_THE_RECOVERY = 'APPLICATION_FOR_THE_RECOVERY'

# виды документов
MAIN_DOC = 'ОСНОВНОЙ ДОКУМЕНТ'
